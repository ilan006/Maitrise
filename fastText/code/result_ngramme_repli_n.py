        ...
        for paragraph in data['paragraphs']:
            for question in paragraph['qas']:
                ...
                for n in range(1, n_param):  # pour tout les n
                    ...
                    list_ans = get_best_repli_sentence_and_all_less_n(model,question['id'], sent_tokenize(paragraph['context']), question['question'], k_best_sentences, n, dict_question= dict_question)
